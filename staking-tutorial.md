---
description: This tutorial will explain how to delegate/stake/unstake your LAYER.
---

# Staking tutorial

Note: You can only stake LAYER which is on Layer network. Please make sure you have changed into Layer network in Metamask while doing any transactions on staking UI. 

How to Stake LAYER:

**Step 1:**

Navigate to staking.layerscan.org and login to your wallet through metamask. Make sure you are on Layer network. If you are not please follow the instructions [**here**](https://docs.layerscan.org/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of LAYER you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 

![](.gitbook/assets/3%20%286%29.png)

**How to Unstake LAYER:**

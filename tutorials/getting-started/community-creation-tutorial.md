...
description: >-
  ...
  the Layer Studio. The guide is aimed at teaching you how to create a new
...
You can also view both your ETH balance and LAYER balance by clicking on “Layer network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on Layer”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to Layer network.
...
It's been a long road, but you are finally on the last step! To be able to make easy mobile transactions using your community, **download the Layer wallet app** on the [App Store](https://apps.apple.com/il/app/fuse-wallet/id1491783654) or [Google Play](https://play.google.com/store/apps/details?id=io.fuse.fusecash).

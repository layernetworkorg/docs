...
description: >-
  ...
  before you launch your community on the Layer Studio.
---
...
**Step 4 -** Congratulations! You now have Ropsten ETH to use! Now you can **access** the[ Layer studio](https://studio.prmscan.org/) which you can also navigate to from the main page of the Layer website. Once there, click on the **'connect wallet'** button, where you can choose to connect with either Metamask \(recommended\) or Torus. Press **connect with Metamask** and vualá!
...
**Step 5 -** To perform actions on the Layer Studio after issuing your community, you will need to **add** the **Layer Custom RPC** to your Metamask. To do so, click on the Metamask icon in your browser, then **select** network and **custom RPC**. Type in the following information into the corresponding fields:

{% hint style="danger" %}
* **Network name:** Layer
* **New RPC URL:**[ ****https://mainnet-rpc.prmscan.org](https://mainnet-rpc.prmscan.org)
* **ChainID:** 39656
* **Symbol:** LAYER
* **Block Explorer URL:**[ ****https://explorer.prmscan.org](https://explorer.prmscan.org)
{% endhint %}
...
**Step 6 -** Ready, set, launch! You are ready to **create your own community** on Layer studio! Simply press the [**launch your community**](https://studio.prmscan.org/view/issuance) ****action button to begin the process. 
...
**Step 2** **-** Next, switch to Ropsten Test Network by clicking on the 'Settings' section in your account and pick **Ropsten Test Network** in the 'Network' tab. You can also switch the network on the  Layer Studio main page by pressing the **wallet tab** and picking '**Switch to Ropsten network**', then clicking confirm.
...
**Step 4 -** Congratulations! You now have Ropsten ETH to use! Now you can **access** the[ Layer studio](https://studio.prmscan.org/) which you can also navigate to from the main page of the Layer website. Once there, click on the **'connect wallet'** button, where you can choose to connect with either Metamask \(recommended\) or Torus. Press **connect with Torus**.
...
**Step 5 -** To use the studio, you will need to **add** the **Layer Custom RPC** to your Torus network settings. To do so, click on the 'Settings' section in your Torus account, then **select** network and custom RPC. Type in the following:
...
Make sure to have the network settings on '**Ropsten Test Network'** for testing purposes or **Main Ethereum Network** when you are ready to launch an official community. You will only need to change to the new RPC Network **after** you have created your community to perform actions on the Layer Studio.

![](../../.gitbook/assets/screenshot-2020-07-29-at-20.32.49.png)

![](../../.gitbook/assets/screenshot-2020-07-31-at-18.47.23.png)

**Step 6 -** Ready, set, launch! You are ready to **create your own community** on Layer studio! Simply press the [launch you community](https://studio.prmscan.org/view/issuance) ****action button to begin the process.
